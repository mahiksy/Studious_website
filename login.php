...
<div class="myCSS w3-blue">
	...
	<form method="post">
		<label class="textUp" for="username"><b>Username:</b></label>
		...
		<button class=" w3-hover-light-blue button" type="submit"><b>Sign In</b></button></button>
		<br>
		...
		<p class="paragraph"><strong>You dont have an account?</strong></p>
		<a class="link" href="<?php echo $signUp ?>">
		<button id="signup"class=" w3-hover-light-blue button" type="submit" >Sign Up</b></button></button>
		</a>
		<br>
		<?php 
		$error= "<p style='text-align:center; color:black;'><strong>" .$errorMSG. "</strong></P>";
		if($flag==1){
			echo $error ;
		}
		?>
