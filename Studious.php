...
?>
  <div class="w3-bar w3-indigo w3-card w3-left-align w3-large">
    ...
    <a href="<?php echo $title?>" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-light-blue">Library</a>
    <a href="logout.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-light-blue">Log out</a>
  </div>
